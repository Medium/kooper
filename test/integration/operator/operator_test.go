...
import (
	...
	superherov1alpha1 "github.com/Medium/kooper/test/integration/operator/apis/superhero/v1alpha1"
	integrationtestk8scli "github.com/Medium/kooper/test/integration/operator/client/k8s/clientset/versioned"
