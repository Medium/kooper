...
docker run --name ctrl1 \
    ...
    -v `pwd`:/go/src/github.com/Medium/kooper:ro  \
    golang go run /go/src/github.com/Medium/kooper/examples/leader-election-controller/main.go
```
...
[leaderelection-src]: https://github.com/Medium/kooper/tree/master/operator/controller/leaderelection
[leaderelection-example]: https://github.com/Medium/kooper/tree/master/examples/leader-election-controller